        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5">
              <span className="grid h-11 w-11 place-items-center rounded-2xl gradient-hero shadow-playful">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-muted-foreground">
              <li className="flex gap-2"><Phone className="h-4 w-4 mt-0.5 shrink-0 text-primary" /> +90 (212) 000 00 00</li>
              <li className="flex gap-2"><Mail className="h-4 w-4 mt-0.5 shrink-0 text-primary" /> merhaba@bihteranaokulu.com</li>
              <li className="flex gap-2"><MapPin className="h-4 w-4 mt-0.5 shrink-0 text-primary" /> Bahçelievler Mah. Papatya Sk. No:12, İstanbul</li>
            </ul>
          </div>
        </div>
